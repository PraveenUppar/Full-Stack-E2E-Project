            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'docker-cred') {
                        dir('api') {
                            sh 'docker build -t praveenuppar/backend:latest .'
                            sh 'trivy image --format table -o backend-image-report.html praveenuppar/backend:latest '
                            sh 'docker push praveenuppar/backend:latest'
